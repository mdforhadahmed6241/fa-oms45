...
class OMS_Admin {
    ...
    public function plugin_admin_menu() {
        ...
        $pages = [
            ...
            $return_page = add_submenu_page('order-management-summary', 'Return Product', 'Return Product', 'manage_options', 'oms-return-product', [$this, 'render_return_product_page']), // NEW: Return Product Page
        ...
        $status_style_pages = [$order_list_page, $order_details_page, $incomplete_order_details_page, $incomplete_list_page, $return_page]; // NEW: Added $return_page
